    ...
    <div>
        ...
        <form >
            <div className='mb-5'>
                ...
                <input type='text' name='bio' value={formData.bio} onChange={handleInputChange} placeholder='' className='form_input' maxLength={100} />
                </div>
                ...
                <div className='mb-5'>
                     ...
                     <button onClick={addQualification} className='bg-[#000] py-2 px-5 mt-5 rounded text-white h-fit cursor-pointer'> Add Qualifications</button>
                </div>
                ...
                <div className='mb-5'>
                     ...
                     <button onClick={addExperience} className='bg-[#000] py-2 px-5 mt-5 rounded text-white h-fit cursor-pointer'> Add Experiences</button>
                </div>
                ...
                <div className='mb-5'>
                     ...
                     <button onClick={addTimeSlot}  className='bg-[#000] py-2 px-5 mt-5 rounded text-white h-fit cursor-pointer'> Add TimeSlot</button>
                </div>
                <div className="mb-5">
                ...
                <div className='relative w-[130px] h-[50px]'> 
                  ...
                  <label htmlFor="customFile" className='absolute top-0 left-0 w-full h-full flex items-center px-[0.75rem] py-[0.375rem] text-[15px] leading-6 overflow-hidden bg-[#0066ff46] text-headingColor font-semibo ld rounded-lg truncate cursor-pointer'> Upload Photo</label>
                </div>
