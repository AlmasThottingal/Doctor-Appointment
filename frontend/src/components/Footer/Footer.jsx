...
const socialLinks = [
  {
    path:"https://www.youtube.com/@apollohospitalsindia",
  ...
  {
    path:"https://www.instagram.com/theapollohospitals/?hl=en",
        ...
        <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px] ">
              <div>
                ...
                <p className='text-[16px] leading-7 font-[400] text-textColor'>
                  Copyright &copy; {year} developed by Almas Thottingal all right reserved . 
                  </p>
